<?php include('head.php');?> 
		<div class="main-container">
		                ...
		                <div class="col-sm-6 col-md-offset-1 p0">
		                    <div class="text-center col-sm-4">
		                        <div class="feature bordered mb30">
		                            <h1 style='font-size: 42px;'>3–5</h1>
		                            <h5 class="uppercase">Hotshots Blue</h5>
		                        </div>
		                    </div>
		                    
		                    <div class="text-center col-sm-4">
		                        <div class="feature bordered mb30">
		                            <h1 style='font-size: 42px;'>5–7</h1>
		                            <h5 class="uppercase">Hotshots Red</h5>
		                        </div>
		                    </div>
		                    
		                    <div class="text-center col-sm-4">
		                        <div class="feature bordered mb30">
		                            <h1 style='font-size: 42px;'>6–10</h1>
		                            <h5 class="uppercase">Hotshots Orange</h5>
		                        </div>
		                    </div>
		        ...
		        <div class="container">
		            <div class="row">
		                <div class="col-sm-10 col-sm-offset-1 text-center">
		                    <h3 class="uppercase color-primary mb40 mb-xs-24">Learning Through Play</h3>
		                    <p class="lead">
		    ...
		    </section><section class='bg-dark' style='background-color: #5edcd0;'>
		        <div class="container">
		            <div class="row">
		                <div class="col-sm-10 col-sm-offset-1 text-center">
		    ...
		    </section><section class='bg-dark' style='background-color: #e31d3b'>
		        <div class="container">
		            <div class="row">
		                <div class="col-sm-10 col-sm-offset-1 text-center">
