...
if(isset($_POST['email'])) {
	...
	$transport = Swift_SmtpTransport::newInstance('petyrbaelish.asoshared.com', 465, 'ssl' )
	  ->setUsername('info@scorpiontennis.com.au')     
	  ->setPassword('dHarrison008')
	  ;
	...
	$message = Swift_Message::newInstance('Scorpion Tennis Website Inquiry')
	  ->setFrom(array($_POST['email'] => $_POST['name']))
	  ->setTo(array('info@scorpiontennis.net' => 'Scorpion Tennis'))
	  ->setCc(array('isaac.n@icloud.com' => 'Webmaster','scorpion001@gmail.com' => 'Scorpion'))
	  ->setBody($messageText);
//                           ^                    ^
